...
CREATE FUNCTION text2vec("input" TEXT) RETURNS vector
STRICT PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', '_vectors_text2vec_wrapper';

-- CREATE FUNCTION text2vec_array(inputs text[]) SETOF vector
-- STRICT PARALLEL SAFE LANGUAGE c AS 'MODULE_PATHNAME', '_vectors_text2vec_array_wrapper';
